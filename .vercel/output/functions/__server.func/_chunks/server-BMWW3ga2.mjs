...
import { C as isResolvedRedirect, E as invariant, S as isRedirect, _ as getScriptPreloadAttrs, a as RouterProvider, b as resolveManifestCssLink, g as getManifestScriptFormat, t as renderRouterToStream, v as getStylesheetHref, w as isNotFound, x as executeRewriteInput, y as resolveManifestAssetLink } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as createMemoryHistory } from "../_libs/tanstack__history.mjs";
import { a as mergeHeaders, c as createSerializationAdapter, d as iu, f as su, i as getOrigin, l as makeSerovalPlugin, n as attachRouterServerSsrUtils, o as defaultSerovalPlugins, r as getNormalizedURL, s as createRawStreamRPCPlugin, t as defineHandlerCallback, u as Pu } from "../_libs/@tanstack/router-core+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CnKQN0VP.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DoAxwh5p.mjs").then((n) => n.a),
		import("./start-BECccD3a.mjs"),
...
function createStartHandler(cbOrOptions) {
	...
	const finalManifestResolver = createFinalManifestResolver({ ...handlerOptions });
