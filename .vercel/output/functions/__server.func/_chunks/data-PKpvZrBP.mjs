//#region dist/server/assets/data-PKpvZrBP.js
const destinos = [
	{
		id: "los-angeles",
		cidade: "Los Angeles",
		pais: "Estados Unidos",
		descricao: "A cidade dos sonhos californiana recebe alguns dos maiores jogos da Copa 2026. Praias douradas, Hollywood e o icônico SoFi Stadium aguardam você.",
	...
	},
	{
		...
		cidade: "Miami",
		pais: "Estados Unidos",
		descricao: "Sol, neon e arquitetura art déco. Miami combina o calor latino com a sofisticação americana em uma experiência inesquecível.",
	...
	},
	{
		...
		pais: "México",
		descricao: "Capital vibrante que abrirá a Copa 2026 no histórico Estádio Azteca. Cultura milenar, gastronomia premiada e energia única.",
...
//#endregion
export { fmtBRL as n, pacotes as r, destinos as t };
